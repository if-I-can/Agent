    ...
    try:
        with open(file_path, 'r') as file:
            for line in file:
                ...
                avg = sum(values) / (len(values)+0.00001)  # 计算每行的平均值
...
def track(video_path):
    ...
    parser.add_argument('--model_path', default='/home/zsl/Agent/best.pt', type=str, help='Path to the YOLOv8 model file')
    ...
    import subprocess
    folder_path1 = "/home/zsl/Agent/track_data"  # 替换为你要删除的文件夹路径
    folder_path2 = "/home/zsl/Agent/runs"  # 替换为你要删除的文件夹路径
